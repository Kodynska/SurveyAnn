...
return array (
  ...
  'onmotion/yii2-widget-upload-crop' => 
  array (
    'name' => 'onmotion/yii2-widget-upload-crop',
    'version' => '0.5.2.0',
    'alias' => 
    array (
      '@onmotion/yii2/widget/upload/crop' => $vendorDir . '/onmotion/yii2-widget-upload-crop',
    ),
  ),
  ...
  array (
    'name' => 'cenotia/yii2-remote-modal',
    'version' => '1.0.3.0',
    'alias' => 
    array (
      '@cenotia/components/modal' => $vendorDir . '/cenotia/yii2-remote-modal',
    ),
  ),
  'onmotion/yii2-survey' => 
  array (
    'name' => 'onmotion/yii2-survey',
    'version' => '0.1.4.0',
    'alias' => 
    array (
      '@onmotion/survey' => $vendorDir . '/onmotion/yii2-survey',
    ),
  ),
  'pollext/poll' => 
  array (
